...
Instead please use this [Report a Vulnerability](https://github.com/solana-program/feature-proposal/security/advisories/new) link.
...
Only the `spl-feature-proposal` program is included in the bounty scope, at
[program](https://github.com/solana-program/feature-proposal/tree/master/program).
